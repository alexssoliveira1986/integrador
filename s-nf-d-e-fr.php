...
.footer {
    ...
    width:100%;
		...
		<form action="select-nf-data-erro-rel.php" id="unidade" target="iframe_b"  <?php echo $_SERVER['PHP_SELF']; ?>" method="POST"
		enctype="multipart/form-data" >
		<center> <i class='fas fa-copyright'></i> <strong> Consulta NF por Data com Erro <br> Periodo: </strong>
