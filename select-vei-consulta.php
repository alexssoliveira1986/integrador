...
.footer {
    ...
    width:100%;
		...
		<form action="select-vei-consulta-1.php" target="iframe_b" id="codigo"  <?php echo $_SERVER['PHP_SELF']; ?>" method="POST"
		enctype="multipart/form-data" >
		<center><i class='fas fa-car-side'></i><strong> Veiculos<br> Codigo do Veiculo:<strong>
		<input type="number" style="width:60px;font-size: 13px" maxlength="10" name="codigo" value="266131" required >
