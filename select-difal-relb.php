...
.footer {
	...
	//echo date('d-m-Y',  strtotime($date1n)).'<br>';
	//echo date('d-m-Y',  strtotime($date2n)).'<br>';
	...
	$sql = ("SELECT DOCTRD,DOCSES,DOCSTS,DOCEST,DOCEMI,DOCNUM,DOCSER,DOCDTR,DOCTIP,DOCCGC_CLI,DOCINS_CLI,DOCNOM_CLI,DOCCID_CLI,DOCCHA FROM tb_pcadoc where docest <> 'SP' and docser='55' and docses='S' and docsts <> 'C' and docdtr between '$date1n' and '$date2n' order by docest, docdtr, docnum");
