...
.footer {
    ...
    width:100%;
		...
		<form action="select-nf-1.php" id="unidade" target="iframe_b"  <?php echo $_SERVER['PHP_SELF']; ?>" method="POST"
		enctype="multipart/form-data" >
		<center> <i class='fas fa-copyright'></i> <strong> Consulta NF <br> Nota Fiscal:
		<input type="text" style="width:70px;font-size: 13px" maxlength="10" name="nf" value="422989" required >
		Serie:
		<input type="text" style="width:30px;font-size: 13px" maxlength="2" name="serie" value="55" required > 
		Unidade:</strong> 
 ...
 <?php //echo "<meta HTTP-EQUIV='refresh' CONTENT='160;URL=bd-u1.php'>"; 398931 ?>
	</body>
</html>