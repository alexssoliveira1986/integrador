...
.footer {
  ...
  <a class="navbar-brand" href="entrar-geral.php">
	...
	<li class="dropdown">
		<a href="javascript:void(0)" class="dropbtn">Consultas</a><a class="fas fa-chevron-right"></a><font color="white"> Consulta NF</font>
			<div class="dropdown-content">
		...
		<br>
		<form action="select-nf-1.php" id="unidade" target="_self"  <?php echo $_SERVER['PHP_SELF']; ?>" method="POST"
		enctype="multipart/form-data" >
		Informe a NF:<br>
		<input type="number" style="width:120px;font-size: 13px" maxlength="10" name="nf" value="306720" required > <br><br>
		Informe Unidade:<br>
