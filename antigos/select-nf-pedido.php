...
.footer {
  ...
  <a class="navbar-brand" href="entrar-geral.php">
	...
	<li class="dropdown">
		<a href="javascript:void(0)" class="dropbtn">Consultas</a><a class="fas fa-chevron-right"></a><font color="white"> Consulta NF por Pedido</font>
			<div class="dropdown-content">
		...
		<form action="select-nf-pedido-1.php" id="unidade" target="_self"  <?php echo $_SERVER['PHP_SELF']; ?>" method="POST"
		enctype="multipart/form-data" >
		Informe o Pedido:<br>
		<input type="number" style="width:80px;font-size: 13px" maxlength="8" name="pedido" value="50571" required > <br><br>
		Informe a Origem:<br>
		<input type="number" style="width:50px;font-size: 13px" maxlength="2" name="origem" value="96" required > <br><br>
		Informe o Tipo:<br>
		<input type="text" style="width:30px;font-size: 13px" maxlength="1" name="tipo" value="P" required > <br><br>
		Informe o Codigo do Cliente:<br>
		<input type="text" style="width:80px;font-size: 13px" maxlength="8" name="clicli" value="N08146" required > <br><br>
		Informe Unidade:<br>
