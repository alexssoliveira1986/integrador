...
//Fica armazenado arquivos XML
	...
	$link1 = $diretorio . basename($_FILES['arquivo1']['name']);
	$link2 = $diretorio . basename($_FILES['arquivo2']['name']);
	$xml = simplexml_load_file($link);
	$xml1 = simplexml_load_file($link1);
	$xml2 = simplexml_load_file($link2);
