...
.footer {
  ...
  <a class="navbar-brand" href="index.php">
    <i class="far fa-edit"></i>
	 ...
	 <li class="dropdown">
		 <a href="javascript:void(0)" class="dropbtn">Relatórios</a><a class="fas fa-chevron-right"></a><font color="white"> Relatório Veiculo SAIDA</font>
	...
	echo '<strong>'.'Periodo ' . $date1 . ' ' . ' até ' . $date2 .'</strong>'.'<br>'.'<br>';
	...
	<ul>
		...
		<li><a href="select-vei-sai-rel-xls.php" target="_self" onclick="submit()">Gerar XLS</button></a></li>
		</ul>
