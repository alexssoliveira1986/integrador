...
.footer {
	...
	$sqldoc=("UPDATE TB_PCADOC SET DOCEST =:n3 WHERE DOCNUM = :upnota1 AND DOCSER=:upnota2 AND DOCSES=:upnota3 AND DOCCME=:upnota4 AND DOCORI=:upnota5 ");
	  
		$sqldoc = $conn->prepare($sqldoc);
        $sqldoc->bindParam(1, $n3);
	...
	$sqldoc=("UPDATE TB_PCADOC SET DOCNOP =:n1 WHERE DOCNUM = :upnota1 AND DOCSER=:upnota2 AND DOCSES=:upnota3 AND DOCCME=:upnota4 AND DOCORI=:upnota5 ");
		
		$sqldoc = $conn->prepare($sqldoc);
        $sqldoc->bindParam(1, $n1);
        $sqldoc->bindParam(2, $upnota1);
		$sqldoc->bindParam(3, $upnota2);
		$sqldoc->bindParam(4, $upnota3);
		$sqldoc->bindParam(5, $upnota4);
	...
	$sqldoi=("UPDATE TB_PCADOI SET DOIEST =:n3 WHERE DOINUM = :upnota1i AND DOISER=:upnota2i AND DOISES=:upnota3i AND DOICME=:upnota4i AND DOIORI=:upnota5i ");
	  
		$sqldoi = $conn->prepare($sqldoi);
        $sqldoi->bindParam(1, $n3);
	...
	$sqldoi=("UPDATE TB_PCADOI SET DOINOP =:n1 WHERE DOINUM = :upnota1i AND DOISER=:upnota2i AND DOISES=:upnota3i AND DOICME=:upnota4i AND DOIORI=:upnota5i ");
	  
		$sqldoi = $conn->prepare($sqldoi);
        $sqldoi->bindParam(1, $n1);
        $sqldoi->bindParam(2, $upnota1i);
		$sqldoi->bindParam(3, $upnota2i);
		$sqldoi->bindParam(4, $upnota3i);
		$sqldoi->bindParam(5, $upnota4i);
