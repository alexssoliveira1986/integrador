...
.footer {
	...
	$pedido = $_SESSION["nota"];
	$unidade = $_SESSION['uni'];
	$origem = $_SESSION['origem'];
	$tipo = $_SESSION['tipo'];
	$ncontrolenfh = $_SESSION["ncontrolenfh"];
	$ncontrolenfh3 = $_SESSION["ncontrolenfh3"];
	...
	$sql = ("select * from tb_fatnfh where NFHNUR = '$pedido' and NFHORI = '$origem' and NFHTIP = '$tipo' and NFHEMI= '$unidade'  ");
...
$sql = ("select * from tb_fatnfh where NFHNUR = '$pedido' and NFHORI = '$origem' and NFHTIP = '$tipo' and NFHEMI= '$unidade'  ");
	...
	echo '<strong>' . '<hr>' . 'Pedido: ' . '</strong>' . $pedido . '<strong>' . ' Origem: ' . '</strong>' .  $origem . '<strong>' . ' Unidade: ' . '</strong>' . $unidade . '<strong>' ;
	...
	//if (isset ($row['NFHVTN'])){
	//}else echo '<strong>' . 'Pedido: ' . '</strong>' . $nota . '<strong>' . ' Serie: ' . '</strong>' . ' 55 ' . '<strong>' . 'Unidade: ' . '</strong>' . $unidade . '<strong>'. ' NÃO ENCONTRADA'.'</strong>' . '<hr>';
