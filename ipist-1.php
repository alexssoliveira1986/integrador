...
.footer {
	...
	echo '<hr>'.'Periodo ' . $date1 . ' ' . ' até ' . $date2 .' - IPI/ST'.'<hr>';
	...
	$sql = ("SELECT DOIEMI, DOINUM, DOISER, DOIDTR, DOINOP, DOICME, DOIORI, DOITRD, DOILIN, DOIPRO, DOIBIC, DOIAIC, DOIVIC, DOIBST, DOICST_GER, DOIVTI, DOIIPI FROM TB_PCADOI WHERE DOILIN='PI' AND DOISTS <> 'C' AND DOIDTR between '$date1' and '$date2' ORDER BY DOIEMI");
	...
	<font size="3" face="Calibri">
	<ul>
		<li><a href="ipist-1b.php" target="iframe_b" onclick="submit()">Visualizar</button></a></li>
