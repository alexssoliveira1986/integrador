...
.footer {
    ...
    width:100%;
		...
		<center> <i class='fas fa-copyright'></i> <strong> EMAIL <br>
		<form action="email3.php" id="email" target="iframe_b"  <?php echo $_SERVER['PHP_SELF']; ?>" method="POST"
		enctype="multipart/form-data" >PERIODO: 
		...
		TIPO:</strong> 
		<select name="email" form="email">
		  <option value="03">VEICULOS</option>
