...
.footer {
    ...
    width:100%;
		...
		<form action="dare-1.php" id="unidade" target="iframe_b"  <?php echo $_SERVER['PHP_SELF']; ?>" method="POST"
		enctype="multipart/form-data" >
		<center> <i class='fas fa-book'></i> <strong> Livro Dare<br> Nota Fiscal:
		<input type="text" style="width:70px;font-size: 13px" maxlength="10" name="nf" value="309292" required >
		Serie:
