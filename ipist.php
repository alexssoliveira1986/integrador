...
.footer {
    ...
    width:100%;
		...
		<form action="ipist-1.php" target="iframe_b"  <?php echo $_SERVER['PHP_SELF']; ?>" method="POST"
		enctype="multipart/form-data" >
		<center> <i class='fas fa-registered'></i> <strong> Relatório IPI/ST <br> Periodo: </strong>
