...
.footer {
    ...
    width:100%;
		...
		<form action="select-vei-ent-rel.php" id="tipo" target="iframe_b"  <?php echo $_SERVER['PHP_SELF']; ?>" method="POST"
		enctype="multipart/form-data" >
		<center> <i class='fas fa-registered'></i> <strong> Relatório Veiculos <br> Periodo: 
