...
.footer {
	...
	echo '<hr>'.'Periodo ' . $date1n . ' até ' . $date2n . ' - NOVOS'. '<hr>';
	...
	<font size="3" face="Calibri">
		...
		<li><a href="#" target="_self" onclick="submit()">Gerar XLS</button></a></li>
		</ul>
	<?php
	exit;
	}	
	elseif ($mkt=='usado'){
	require("bd-u1.php");
	echo '<hr>'.'Periodo ' . $date1n . ' até ' . $date2n . ' - USADOS'. '<hr>';
	...
	echo '<hr>'.'Periodo ' . $date1n . ' até ' . $date2n . ' - ECOMMERCE'. '<hr>';
	...
	if ($row['DOCTOS'] == 'F2'){
		echo "<td>" . number_format (str_replace(",",".",$xvlm),"2",",","") . "</td>";
	}else echo "<td>" . number_format (str_replace(",",".",$xvic),"2",",","") . "</td>";
